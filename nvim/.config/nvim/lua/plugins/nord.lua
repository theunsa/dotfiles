return {
  {
    ...
    config = function()
      ...
      local function apply_ui_backgrounds()
        ...
        vim.api.nvim_set_hl(0, "SnacksPickerFile", { fg = nord.snow_storm_0 })
        vim.api.nvim_set_hl(0, "SnacksPickerDirectory", { fg = nord.frost_2 })
        vim.api.nvim_set_hl(0, "SnacksPickerDir", { fg = nord.frost_2 })
        vim.api.nvim_set_hl(0, "SnacksPickerPathHidden", { fg = nord.frost_2 })
        vim.api.nvim_set_hl(0, "SnacksPickerPathIgnored", { fg = nord.frost_2 })
        ...
        vim.api.nvim_set_hl(0, "SnacksPickerGitStatusIgnored", { fg = nord.frost_2 })
        vim.api.nvim_set_hl(0, "MiniIconsGrey", { fg = nord.frost_2 })
      end
